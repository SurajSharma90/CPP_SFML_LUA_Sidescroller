...
int Engine::cpp_clearWindow(lua_State* L)
{
	...
	const sf::Uint8 r = lua_tointeger(L, 1);
	const sf::Uint8 g = lua_tointeger(L, 2);
	const sf::Uint8 b = lua_tointeger(L, 3);
	const sf::Uint8 a = lua_tointeger(L, 4);
